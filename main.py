...
class Main(tk.Frame):
    ...
    def delete_records(self): #удаляет данные
    ...
    def update_record(self, name, tel, email, salary): # обновление (изменение) данных
...
class Search(tk.Toplevel):
    ...
    def init_search(self):
        ...
        btn_search = ttk.Button(self, text='Поиск') #Кнопка 
...
class DB:
  # Создание подключения к бд
    def __init__(self):
      ...
      # Метод который создает таблицу 'Сотрудники'
